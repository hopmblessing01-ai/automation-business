...
export const aboutValues = [
  {
    mark: "8+",
    title: "Years in automation",
    body: "From early Zapier stacks to production n8n and custom API middleware.",
  },
  {
    mark: "∞",
  ...
  },
  {
    ...
    body: "Architected so volume increases don’t break the fragile parts first.",
  },
] as const;
